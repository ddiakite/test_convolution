        ...
        const T *__restrict__ mask, size_t mask_width, std::vector<elapsed_time_t> &results, size_t loop_count)
{
    ...
    cl_mem mask_fpga = clCreateBuffer(context, CL_MEM_READ_WRITE,mask_width * mask_width * sizeof(size_t),NULL,&ret);
    ...
    ret = clEnqueueWriteBuffer(queue, mask_fpga, CL_TRUE, 0, mask_width * mask_width * sizeof(size_t), mask, 0, NULL, NULL); 
